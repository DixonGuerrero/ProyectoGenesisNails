...
<!--         <li><a href="#contacto" class="nav_link">Contacto</a></li>
 -->      </ul>
      ...
      <a href="<?= APP_URL?>formulario" class="hero_btn">Ingresar</a>

      <a href="#menu" class="nav_menu">
        <img src="./assets/icons/menuIcon.svg" alt="" class="nav_icon" />
      </a>

      <a href="#" class="nav_menu nav_menu--second">
        <img src="./assets/icons/closeMenuIcon.svg" alt="" class="nav_icon" />
      </a>

      <ul class="dropdown" id="menu">
        <li class="dropdown_list">
          <a href="#" class="dropdown_link">
            <img src="./assets/icons/homeIcon.svg" alt="" class="dropdown_icon" />
        ...
        <li class="dropdown_list">
          <a href="#quienesSomos" class="dropdown_link">
            <img src="./assets/icons/nosotrosIcon.svg" alt="" class="dropdown_icon" />
        ...
        <li class="dropdown_list">
          <a href="#" class="dropdown_link">
            <img src="./assets/icons/servicios.svg" alt="" class="dropdown_icon" />
            <span class="dropdown_span">Servicios</span>
            <img src="./assets/icons/flechaIcon.svg" alt="" class="dropdown_arrow" />
          ...
          <div class="dropdown_content">
            <ul class="dropdown_sub">
              <li class="dropdown_li">
                <a href="#acrilico" class="dropdown_anchor">Uñas en acrilico</a>
              </li>
              <li class="dropdown_li">
                <a href="#cepilladoAlisado" class="dropdown_anchor">Cepillado y Alisado</a>
              </li>
              <li class="dropdown_li">
                <a href="#semipermanente" class="dropdown_anchor">Uñas en Semipermantente</a>
              </li>
              <li class="dropdown_li">
                <a href="#manicurePedicure" class="dropdown_anchor">Manicure y Pedicure Tradicional</a>
              </li>
              <li class="dropdown_li">
                <a href="#cejasdesing" class="dropdown_anchor">Diseño de Cejas</a>
              </li>
              <li class="dropdown_li">
                <a href="#extencionCejas" class="dropdown_anchor">Extension de Pestañas</a>
              </li>
            </ul>
          </div>
        </li>
...
<!--         <li class="dropdown_list">
          <a href="#contacto" class="dropdown_link">
            <img src="./assets/icons/contactoIcon.svg" alt="" class="dropdown_icon" />
            <span class="dropdown_span">Contacto</span>
          </a>
        </li> -->

        <li class="dropdown_list list-ingresar">
          <a href="<?= APP_URL?>formulario" class="dropdown_link link_ingresar">
            <img src="./assets/icons/ingresarIcon.svg" alt="" class="dropdown_icon" />
            <span class="dropdown_span" href="<?= APP_URL?>formulario">Ingresar</span>
          </a>
        </li>
      </ul>
    </nav>
    ...
    <section class="hero_main container">
      <div class="hero_texts">
        ...
        <a href="<?= APP_URL?>formulario" class="hero_cta">Ingresa Ya!</a>
      </div>

      <figure class="hero_picture">
        <img src="./assets/images/logo.png" alt="LogoPortadaPagina" class="hero_img" />
      </figure>
    </section>
  </header>
  ...
  <section class="sobreNosotros container" id="quienesSomos">
    <img src="./assets/images/salonBellezaImg.jpg" alt="" class="sb_img" />
    ...
    <div class="container-S">
      ...
      <div class="containerServicios">
        <div class="cartaServicios" id="cepilladoAlisado">
          ...
          <a href="<?= APP_URL?>formulario" class="btn-servicios">¡Reserva Ahora!</a>
        </div>
        <div class="cartaServicios" id="acrilico">
          ...
          <a class="btn-servicios" href="<?= APP_URL?>formulario">¡Reserva Ahora!</a>
        </div>
    ...
    <div class="form-Contacto">
      ...
      <form action="" class="contacto_formulario">
        <div class="contacto_input-line">
          ...
          <input type="text" name="name" id="name" placeholder="Ingrese su nombre" class="contacto_input" />
        </div>
        <div class="contacto_input-line">
          <label for="email" class="contacto_label">Email</label>
          <input type="text" name="email" id="email" placeholder="Ingrese su email" class="contacto_input" />
        </div>
        <div class="contacto_input-line">
          <label for="telefono" class="contacto_label">Telefono</label>
          <input type="text" name="telefono" id="telefono" placeholder="Ingrese su telefono" class="contacto_input" />
        </div>
        <div class="contacto_input-line">
          <label for="mensaje" class="contacto_label">Mensaje</label>
          <textarea type="text" name="mensaje" id="mensaje" placeholder="Ingrese su mensaje" class="contacto_input_textarea"></textarea>
        </div>

        <input type="submit" value="Enviar mensaje" class="contacto_submit-boton" />
      </form>
    </div>
  </section> -->
      ...
      <div class="grupo1">
        ...
        <div class="box">
          <figure class="container_img_footer">
            <a href="#"><img src="./assets/images/logo 4.png" alt="logo de Genesis Nails" class="footer_img" /></a>
          </figure>
        </div>
        <div class="box">
